...
# 1. Uninstall old xenova package and install the official huggingface v3 package
echo "Updating dependencies..."
npm uninstall @xenova/transformers
npm install @huggingface/transformers

# 2. Update Tool.jsx with the robust Xenova/RMBG-1.4 implementation
...
# 3. Fix the "onnxruntime_binding.node" error in next.config.mjs
