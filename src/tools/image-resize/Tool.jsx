...
export default function ImageResizeTool() {
  ...
  const inputClass =
    "w-full bg-bg border border-border rounded-lg px-4 py-2.5 font-mono text-sm text-ink focus:outline-none focus:border-ink transition-colors";
    ...
    <div className="space-y-8">
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <div
                    ...
                    className={`w-10 h-5 rounded-full transition-colors ${
                      settings.maintainAspectRatio ? "bg-ink" : "bg-border"
                    } relative`}
                  >
                    <div
              ...
              <div className="space-y-3">
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-xs font-mono">
                  ...
                  <span className="text-muted">
                    ...
                    <span
                      className={
                        result.newKB < result.originalKB
                          ? "text-green-600"
                          : "text-accent"
                      }
                    >
                    ...
                    <span className="text-muted">
                      (was {result.originalKB} KB)
                    </span>
                  </span>
                </div>
                <button
                  onClick={handleDownload}
                  className="w-full bg-accent text-white font-display font-bold py-3.5 rounded-lg hover:bg-ink transition-colors"
                >
      ...
      {image && (
        <button
          ...
          className="text-sm text-muted font-mono hover:text-ink transition-colors"
        >
          ← Use different image
        </button>
      )}
