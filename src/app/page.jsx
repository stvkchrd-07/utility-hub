...
export default function Home() {
  const toolList = Registry.tools || Registry.TOOLS || Registry.default || [];
      ...
      <header className="pt-24 pb-12 px-6 sm:px-12 max-w-7xl mx-auto border-b border-border mb-10">
        <div className="max-w-3xl space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2 sm:gap-8 text-sm font-mono text-muted">
            <div className="flex items-center gap-2">âš¡ Instant processing</div>
            <div className="flex items-center gap-2">í´’ Zero server uploads</div>
            <div className="flex items-center gap-2">í¶“ No account needed</div>
          </div>
        </div>
      </header>
